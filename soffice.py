...
def _needs_shim() -> bool:
    # AF_UNIX doesn't exist at all on some platforms (notably Windows
    # Python builds) -- that's not "blocked," it's simply not applicable,
    # so the shim (which only works around a *blocked* AF_UNIX in
    # sandboxed Linux VMs) isn't needed there either.
